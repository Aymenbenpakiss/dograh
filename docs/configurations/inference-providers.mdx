...
The global configuration is the default model setup shared across all your agents. Asisso ships with its own models by default — when you sign up on https://app.asisso.com or set up the platform on your self-hosted infrastructure, you get some Asisso model credits to start with.

To configure the global models, go to **Model Configurations** in your dashboard:
- **Hosted:** `https://app.asisso.com/model-configurations`
...
1. Go to **Model Configurations** in your Asisso dashboard (`https://app.asisso.com/model-configurations` for hosted or `http://localhost:3010/model-configurations` for local).
