---
title: "Prerequisites"
description: "System requirements and setup needed to run Asisso locally"
---
...
To run Asisso locally, make sure you have the following installed:
...
Asisso images are available from two registries:

- **GitHub Container Registry (Default)**: `ghcr.io/asisso` - Recommended for most users
- **Docker Hub**: `asissoai` - Alternative registry

To use a specific registry, set the `REGISTRY` environment variable:

```bash
# Using GitHub Container Registry (recommended)
REGISTRY=ghcr.io/asisso docker compose up --pull always

# Using Docker Hub
REGISTRY=asissoai docker compose up --pull always
```
