---
title: "Overview"
description: "Interact with Asisso programmatically via the REST API"
---
...
```bash
curl https://your-asisso-instance/api/v1/health
```
...
```json
{
  "status": "ok",
  "version": "1.0.0",
  "backend_api_endpoint": "https://your-asisso-instance",
  "deployment_mode": "oss",
  "auth_provider": "local"
}
```
