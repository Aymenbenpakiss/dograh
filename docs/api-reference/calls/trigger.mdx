...
Pass `telephony_configuration_id` to route the call through a specific telephony configuration instead of your organization's default. The id is shown on each row in **Telephony configurations** at [`app.asisso.com/telephony-configurations`](https://asisso.com/app/telephony-configurations).
