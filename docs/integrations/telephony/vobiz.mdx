...
description: "Configure Vobiz for voice communication in Asisso"
---
...
3. Confirm:
   ...
   <Note>
     ...
     yourself, set the method to `POST`, and save. On self-hosted Asisso,
     replace `api.asisso.com` with your backend domain.
   </Note>
