---
title: "Agent Stream"
description: "Stream audio to a Asisso agent over a WebSocket"
---
...
<Warning>
  ...
  request on [GitHub Discussions](https://github.com/asisso/asisso/discussions)
  with your use case.
</Warning>
...
`{agent_uuid}` is the agent's stable UUID (see [Get the Agent UUID](#get-the-agent-uuid) below). On self-hosted deployments, replace `app.asisso.com` with your backend host.
