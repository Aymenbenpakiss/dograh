...
description: "How Asisso handles telephony webhooks and audio streaming"
---

## Overview

Asisso uses webhooks to communicate with telephony providers for call events and audio streaming. Webhooks are automatically configured when you initiate calls.
